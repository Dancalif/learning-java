...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		FunctionCallAlphabet.b();    // returns the word to be displayed
		...
		//f("Fox");    // displays the word you pass it beginning with "F"
		FunctionCallAlphabet.g();    // returns the word to be displayed
		//h(3);    // tell it how many times to display the word (1)
		System.out.println();

		//i(3);    // pass it any integer and it will display a word beginning with I 
		FunctionCallAlphabet.j(2);    // returns a different word depending on what you pass it (1-3)
		...
		//n("cat");    // displays the word you pass it beginning with "N"
		//o();    // displays a word beginning with O and returns a useless value
		FunctionCallAlphabet.p();    // returns the word to be displayed
		//q();    // displays the word
		System.out.println();

		FunctionCallAlphabet.r(true);    // returns a different word depending on if you pass it 'true' or 'false'
		//s(6);    // pass it the number of letters to display (6)
		//t("wolf");    // displays the word you pass it beginning with "T"
		FunctionCallAlphabet.u();    // returns the word to be displayed
		//v(2);    // tell it how many times to display the word (1)
		//w(5);    // pass it any integer and it will display a word beginning with W 
		FunctionCallAlphabet.x(1);    // returns a different word depending on what you pass it (1-2)
		//y();    // displays a word beginning with Y
		FunctionCallAlphabet.z(true, false);    // returns a different word depending on which two boolean values you pass it
		System.out.println();
	}
